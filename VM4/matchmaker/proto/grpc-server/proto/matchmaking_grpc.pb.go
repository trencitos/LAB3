...
const (
	...
	Matchmaker_LeaveQueue_FullMethodName               = "/matchmaking.Matchmaker/LeaveQueue"
	Matchmaker_NotifyMatchEnded_FullMethodName         = "/matchmaking.Matchmaker/NotifyMatchEnded"
...
type MatchmakerClient interface {
	...
	LeaveQueue(ctx context.Context, in *PlayerStatusRequest, opts ...grpc.CallOption) (*LeaveQueueResponse, error)
	NotifyMatchEnded(ctx context.Context, in *MatchEndedRequest, opts ...grpc.CallOption) (*MatchEndedResponse, error)
...
func (c *matchmakerClient) LeaveQueue(ctx context.Context, in *PlayerStatusRequest, opts ...grpc.CallOption) (*LeaveQueueResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LeaveQueueResponse)
	err := c.cc.Invoke(ctx, Matchmaker_LeaveQueue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matchmakerClient) NotifyMatchEnded(ctx context.Context, in *MatchEndedRequest, opts ...grpc.CallOption) (*MatchEndedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MatchEndedResponse)
	err := c.cc.Invoke(ctx, Matchmaker_NotifyMatchEnded_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MatchmakerServer interface {
	...
	LeaveQueue(context.Context, *PlayerStatusRequest) (*LeaveQueueResponse, error)
	NotifyMatchEnded(context.Context, *MatchEndedRequest) (*MatchEndedResponse, error)
	// MÉTODOS PARA SERVIDORES DE PARTIDA (Game Servers)
	// Un servidor de partida se registra o actualiza su estado (DISPONIBLE, OCUPADO).
...
func (UnimplementedMatchmakerServer) LeaveQueue(context.Context, *PlayerStatusRequest) (*LeaveQueueResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LeaveQueue not implemented")
}
func (UnimplementedMatchmakerServer) NotifyMatchEnded(context.Context, *MatchEndedRequest) (*MatchEndedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NotifyMatchEnded not implemented")
}
...
func _Matchmaker_LeaveQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PlayerStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchmakerServer).LeaveQueue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Matchmaker_LeaveQueue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchmakerServer).LeaveQueue(ctx, req.(*PlayerStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Matchmaker_NotifyMatchEnded_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MatchEndedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchmakerServer).NotifyMatchEnded(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Matchmaker_NotifyMatchEnded_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchmakerServer).NotifyMatchEnded(ctx, req.(*MatchEndedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Matchmaker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Matchmaker_LeaveQueue_Handler,
		},
		{
			MethodName: "NotifyMatchEnded",
			Handler:    _Matchmaker_NotifyMatchEnded_Handler,
		},
		{
