...
func (x *MatchEndedRequest) Reset() {
	*x = MatchEndedRequest{}
...
func (x *MatchEndedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MatchEndedRequest) ProtoMessage() {}

func (x *MatchEndedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_matchmaking_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MatchEndedRequest.ProtoReflect.Descriptor instead.
func (*MatchEndedRequest) Descriptor() ([]byte, []int) {
	return file_matchmaking_proto_rawDescGZIP(), []int{2}
}

func (x *MatchEndedRequest) GetMatchId() string {
	if x != nil {
		return x.MatchId
	}
	return ""
...
func (x *MatchEndedRequest) GetPlayerIds() []string {
	if x != nil {
		return x.PlayerIds
	}
	return nil
...
func (x *MatchEndedRequest) GetVectorClock() []int32 {
	if x != nil {
		return x.VectorClock
	}
	return nil
...
type MatchEndedResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MatchEndedResponse) Reset() {
	*x = MatchEndedResponse{}
	mi := &file_matchmaking_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MatchEndedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MatchEndedResponse) ProtoMessage() {}

func (x *MatchEndedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_matchmaking_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MatchEndedResponse.ProtoReflect.Descriptor instead.
func (*MatchEndedResponse) Descriptor() ([]byte, []int) {
	return file_matchmaking_proto_rawDescGZIP(), []int{3}
}

func (x *MatchEndedResponse) GetVectorClock() []int32 {
	if x != nil {
		return x.VectorClock
	}
	return nil
...
func (*SystemStatusResponse_PlayerQueueEntry) Descriptor() ([]byte, []int) {
	return file_matchmaking_proto_rawDescGZIP(), []int{14, 1}
}
...
const file_matchmaking_proto_rawDesc = "" +
	...
	"\fvector_clock\x18\x02 \x03(\x05R\vvectorClock\"p\n" +
	"\x11MatchEndedRequest\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\tR\amatchId\x12\x1d\n" +
	"\n" +
	"player_ids\x18\x02 \x03(\tR\tplayerIds\x12!\n" +
	"\fvector_clock\x18\x03 \x03(\x05R\vvectorClock\"7\n" +
	"\x12MatchEndedResponse\x12!\n" +
	"\fvector_clock\x18\x01 \x03(\x05R\vvectorClock\"\x86\x01\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage2\xd8\x05\n" +
	"\n" +
	"Matchmaker\x12P\n" +
	"\vQueuePlayer\x12\x1f.matchmaking.QueuePlayerRequest\x1a .matchmaking.QueuePlayerResponse\x12V\n" +
	"\x0fGetPlayerStatus\x12 .matchmaking.PlayerStatusRequest\x1a!.matchmaking.PlayerStatusResponse\x12Z\n" +
	"\x18StreamMatchNotifications\x12\x1c.matchmaking.PlayerIdRequest\x1a\x1e.matchmaking.MatchNotification0\x01\x12O\n" +
	"\n" +
	"LeaveQueue\x12 .matchmaking.PlayerStatusRequest\x1a\x1f.matchmaking.LeaveQueueResponse\x12S\n" +
	"\x10NotifyMatchEnded\x12\x1e.matchmaking.MatchEndedRequest\x1a\x1f.matchmaking.MatchEndedResponse\x12e\n" +
...
var file_matchmaking_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_matchmaking_proto_goTypes = []any{
	...
	(*MatchEndedRequest)(nil),                     // 5: matchmaking.MatchEndedRequest
	(*MatchEndedResponse)(nil),                    // 6: matchmaking.MatchEndedResponse
	(*QueuePlayerRequest)(nil),                    // 7: matchmaking.QueuePlayerRequest
	(*QueuePlayerResponse)(nil),                   // 8: matchmaking.QueuePlayerResponse
	(*PlayerStatusRequest)(nil),                   // 9: matchmaking.PlayerStatusRequest
	(*PlayerStatusResponse)(nil),                  // 10: matchmaking.PlayerStatusResponse
	(*MatchNotification)(nil),                     // 11: matchmaking.MatchNotification
	(*ServerStatusUpdateRequest)(nil),             // 12: matchmaking.ServerStatusUpdateRequest
	(*ServerStatusUpdateResponse)(nil),            // 13: matchmaking.ServerStatusUpdateResponse
	(*AssignMatchRequest)(nil),                    // 14: matchmaking.AssignMatchRequest
	(*AssignMatchResponse)(nil),                   // 15: matchmaking.AssignMatchResponse
	(*AdminRequest)(nil),                          // 16: matchmaking.AdminRequest
	(*SystemStatusResponse)(nil),                  // 17: matchmaking.SystemStatusResponse
	(*AdminServerUpdateRequest)(nil),              // 18: matchmaking.AdminServerUpdateRequest
	(*AdminUpdateResponse)(nil),                   // 19: matchmaking.AdminUpdateResponse
	(*SystemStatusResponse_ServerState)(nil),      // 20: matchmaking.SystemStatusResponse.ServerState
	(*SystemStatusResponse_PlayerQueueEntry)(nil), // 21: matchmaking.SystemStatusResponse.PlayerQueueEntry
}
var file_matchmaking_proto_depIdxs = []int32{
	...
	20, // 3: matchmaking.SystemStatusResponse.servers:type_name -> matchmaking.SystemStatusResponse.ServerState
	21, // 4: matchmaking.SystemStatusResponse.player_queue:type_name -> matchmaking.SystemStatusResponse.PlayerQueueEntry
	7,  // 5: matchmaking.Matchmaker.QueuePlayer:input_type -> matchmaking.QueuePlayerRequest
	9,  // 6: matchmaking.Matchmaker.GetPlayerStatus:input_type -> matchmaking.PlayerStatusRequest
	3,  // 7: matchmaking.Matchmaker.StreamMatchNotifications:input_type -> matchmaking.PlayerIdRequest
	9,  // 8: matchmaking.Matchmaker.LeaveQueue:input_type -> matchmaking.PlayerStatusRequest
	5,  // 9: matchmaking.Matchmaker.NotifyMatchEnded:input_type -> matchmaking.MatchEndedRequest
	12, // 10: matchmaking.Matchmaker.UpdateServerStatus:input_type -> matchmaking.ServerStatusUpdateRequest
	16, // 11: matchmaking.Matchmaker.AdminGetSystemStatus:input_type -> matchmaking.AdminRequest
	18, // 12: matchmaking.Matchmaker.AdminUpdateServerState:input_type -> matchmaking.AdminServerUpdateRequest
	14, // 13: matchmaking.GameServer.AssignMatch:input_type -> matchmaking.AssignMatchRequest
	8,  // 14: matchmaking.Matchmaker.QueuePlayer:output_type -> matchmaking.QueuePlayerResponse
	10, // 15: matchmaking.Matchmaker.GetPlayerStatus:output_type -> matchmaking.PlayerStatusResponse
	11, // 16: matchmaking.Matchmaker.StreamMatchNotifications:output_type -> matchmaking.MatchNotification
	4,  // 17: matchmaking.Matchmaker.LeaveQueue:output_type -> matchmaking.LeaveQueueResponse
	6,  // 18: matchmaking.Matchmaker.NotifyMatchEnded:output_type -> matchmaking.MatchEndedResponse
	13, // 19: matchmaking.Matchmaker.UpdateServerStatus:output_type -> matchmaking.ServerStatusUpdateResponse
	17, // 20: matchmaking.Matchmaker.AdminGetSystemStatus:output_type -> matchmaking.SystemStatusResponse
	19, // 21: matchmaking.Matchmaker.AdminUpdateServerState:output_type -> matchmaking.AdminUpdateResponse
	15, // 22: matchmaking.GameServer.AssignMatch:output_type -> matchmaking.AssignMatchResponse
