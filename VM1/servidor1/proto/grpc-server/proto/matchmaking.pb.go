...
func (QueuePlayerResponse_StatusCode) EnumDescriptor() ([]byte, []int) {
	return file_matchmaking_proto_rawDescGZIP(), []int{4, 0}
}
...
const (
	...
	AssignMatchResponse_REJECTED_CRASH AssignMatchResponse_StatusCode = 2
)
...
func (*SystemStatusResponse_PlayerQueueEntry) Descriptor() ([]byte, []int) {
	return file_matchmaking_proto_rawDescGZIP(), []int{13, 1}
}
...
const file_matchmaking_proto_rawDesc = "" +
	...
	"\n" +
	"player_ids\x18\x02 \x03(\tR\tplayerIds\x12!\n" +
	"\fvector_clock\x18\x03 \x03(\x05R\vvectorClock\"\xa6\x01\n" +
	...
	"\rREJECTED_BUSY\x10\x01\x12\x12\n" +
	"\x0eREJECTED_CRASH\x10\x02\"\x0e\n" +
	...
	"\x18StreamMatchNotifications\x12\x1c.matchmaking.PlayerIdRequest\x1a\x1e.matchmaking.MatchNotification0\x01\x12S\n" +
...
var file_matchmaking_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_matchmaking_proto_goTypes = []any{
	...
	(*MatchEndedRequest)(nil),                     // 4: matchmaking.MatchEndedRequest
	(*MatchEndedResponse)(nil),                    // 5: matchmaking.MatchEndedResponse
	(*QueuePlayerRequest)(nil),                    // 6: matchmaking.QueuePlayerRequest
	(*QueuePlayerResponse)(nil),                   // 7: matchmaking.QueuePlayerResponse
	(*PlayerStatusRequest)(nil),                   // 8: matchmaking.PlayerStatusRequest
	(*PlayerStatusResponse)(nil),                  // 9: matchmaking.PlayerStatusResponse
	(*MatchNotification)(nil),                     // 10: matchmaking.MatchNotification
	(*ServerStatusUpdateRequest)(nil),             // 11: matchmaking.ServerStatusUpdateRequest
	(*ServerStatusUpdateResponse)(nil),            // 12: matchmaking.ServerStatusUpdateResponse
	(*AssignMatchRequest)(nil),                    // 13: matchmaking.AssignMatchRequest
	(*AssignMatchResponse)(nil),                   // 14: matchmaking.AssignMatchResponse
	(*AdminRequest)(nil),                          // 15: matchmaking.AdminRequest
	...
	(*SystemStatusResponse_ServerState)(nil),      // 19: matchmaking.SystemStatusResponse.ServerState
	(*SystemStatusResponse_PlayerQueueEntry)(nil), // 20: matchmaking.SystemStatusResponse.PlayerQueueEntry
}
var file_matchmaking_proto_depIdxs = []int32{
	...
	19, // 3: matchmaking.SystemStatusResponse.servers:type_name -> matchmaking.SystemStatusResponse.ServerState
	20, // 4: matchmaking.SystemStatusResponse.player_queue:type_name -> matchmaking.SystemStatusResponse.PlayerQueueEntry
	6,  // 5: matchmaking.Matchmaker.QueuePlayer:input_type -> matchmaking.QueuePlayerRequest
	8,  // 6: matchmaking.Matchmaker.GetPlayerStatus:input_type -> matchmaking.PlayerStatusRequest
	3,  // 7: matchmaking.Matchmaker.StreamMatchNotifications:input_type -> matchmaking.PlayerIdRequest
	4,  // 8: matchmaking.Matchmaker.NotifyMatchEnded:input_type -> matchmaking.MatchEndedRequest
	11, // 9: matchmaking.Matchmaker.UpdateServerStatus:input_type -> matchmaking.ServerStatusUpdateRequest
	15, // 10: matchmaking.Matchmaker.AdminGetSystemStatus:input_type -> matchmaking.AdminRequest
	17, // 11: matchmaking.Matchmaker.AdminUpdateServerState:input_type -> matchmaking.AdminServerUpdateRequest
	13, // 12: matchmaking.GameServer.AssignMatch:input_type -> matchmaking.AssignMatchRequest
	7,  // 13: matchmaking.Matchmaker.QueuePlayer:output_type -> matchmaking.QueuePlayerResponse
	9,  // 14: matchmaking.Matchmaker.GetPlayerStatus:output_type -> matchmaking.PlayerStatusResponse
	10, // 15: matchmaking.Matchmaker.StreamMatchNotifications:output_type -> matchmaking.MatchNotification
	5,  // 16: matchmaking.Matchmaker.NotifyMatchEnded:output_type -> matchmaking.MatchEndedResponse
	12, // 17: matchmaking.Matchmaker.UpdateServerStatus:output_type -> matchmaking.ServerStatusUpdateResponse
	16, // 18: matchmaking.Matchmaker.AdminGetSystemStatus:output_type -> matchmaking.SystemStatusResponse
	18, // 19: matchmaking.Matchmaker.AdminUpdateServerState:output_type -> matchmaking.AdminUpdateResponse
	14, // 20: matchmaking.GameServer.AssignMatch:output_type -> matchmaking.AssignMatchResponse
